...
parser.add_argument('-filter-sizes', type=str, default='1,1,1',
...
parser.add_argument('-pretrained-name', type=str, default='glove.6B.300d.txt',# glove.6B.zip  sgns.zhihu.word
                    help='filename of pre-trained word vectors')
parser.add_argument('-pretrained-path', type=str, default='D\\data\\glove.6B\\', help='path of pre-trained word vectors') # pretrained
...
def load_dataset(text_field, label_field, args, **kwargs):
    ...
    if args.static and args.pretrained_name and args.pretrained_path:
        ...
        text_field.build_vocab(train_dataset, dev_dataset, vectors=vectors) # , vectors=GloVe(name='6B', dim=300)
    else:
